...
/*  The partition for   /dev/block/bootdevice/by-name/cust      */
#define PART_CUST "mmcblk0p23"
...
void submit_bio(int rw, struct bio *bio)
{
	...
	if (bio_has_data(bio)) {
        ...
        if(rw & WRITE)
        {
             ...
             */
            if(((strstr(devname,PART_SYSTEM)!=NULL)||(strstr(devname,PART_MODEM)!=NULL)||(strstr(devname,PART_CUST)!=NULL)) &&
